...
const navigation = [["Overview", "/"], ["Prospects", "/prospects"], ["Signals", "/signals"], ["Opportunities", "/opportunities"], ["Content Studio", "/studio"], ["Publish review", "/publishing"], ["Workflow runs", "/workflows"]] as const;
