...
const navigation = [["Overview", "/"], ["Profile", "/profile"], ["Prospects", "/prospects"], ["Signals", "/signals"], ["Content Studio", "/studio"], ["Briefings", "/briefings"], ["Publish review", "/publishing"], ["Workflow runs", "/workflows"]] as const;
