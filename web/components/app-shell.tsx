...
const navigation = [["Overview", "/"], ["Profile", "/profile"], ["Prospects", "/prospects"], ["Content Studio", "/studio"], ["Briefings", "/briefings"], ["Publish review", "/publishing"], ["Workflow runs", "/workflows"]] as const;
